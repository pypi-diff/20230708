# Comparing `tmp/NeuroNode-3.3.tar.gz` & `tmp/NeuroNode-3.6.tar.gz`
...
## Comparing `NeuroNode-3.3.tar` & `NeuroNode-3.6.tar`
...
### Comparing `NeuroNode-3.3/LICENSE.text` & `NeuroNode-3.6/LICENSE.text`

 * *Files identical despite different names*

### Comparing `NeuroNode-3.3/PKG-INFO` & `NeuroNode-3.6/PKG-INFO`
...
### Comparing `NeuroNode-3.3/pyproject.toml` & `NeuroNode-3.6/pyproject.toml`
...
### Comparing `NeuroNode-3.3/src/NeuroNode.egg-info/PKG-INFO` & `NeuroNode-3.6/src/NeuroNode.egg-info/PKG-INFO`
...
### Comparing `NeuroNode-3.3/src/neuronode/__init__.py` & `NeuroNode-3.6/src/neuronode/__init__.py`
