# Comparing `tmp/curcheck_manager-1.0.1.tar.gz` & `tmp/curcheck_manager-1.0.2.tar.gz`
...
## Comparing `curcheck_manager-1.0.1.tar` & `curcheck_manager-1.0.2.tar`
...
### Comparing `curcheck_manager-1.0.1/curcheck_manager/app.py` & `curcheck_manager-1.0.2/curcheck_manager/app.py`
...
### Comparing `curcheck_manager-1.0.1/curcheck_manager/config.py` & `curcheck_manager-1.0.2/curcheck_manager/config.py`

 * *Files identical despite different names*

### Comparing `curcheck_manager-1.0.1/curcheck_manager/generator.py` & `curcheck_manager-1.0.2/curcheck_manager/generator.py`

 * *Files identical despite different names*

### Comparing `curcheck_manager-1.0.1/curcheck_manager/templates/full/project/{{ cookiecutter.project_name }}/src/core/db.py` & `curcheck_manager-1.0.2/curcheck_manager/templates/full/project/{{ cookiecutter.project_name }}/src/core/db.py`

 * *Files identical despite different names*

### Comparing `curcheck_manager-1.0.1/curcheck_manager/templates/mini/project/{{ cookiecutter.project_name }}/main.py` & `curcheck_manager-1.0.2/curcheck_manager/templates/mini/project/{{ cookiecutter.project_name }}/main.py`

 * *Files identical despite different names*

### Comparing `curcheck_manager-1.0.1/LICENSE` & `curcheck_manager-1.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `curcheck_manager-1.0.1/pyproject.toml` & `curcheck_manager-1.0.2/pyproject.toml`
...
### Comparing `curcheck_manager-1.0.1/setup.py` & `curcheck_manager-1.0.2/setup.py`
...
### Comparing `curcheck_manager-1.0.1/PKG-INFO` & `curcheck_manager-1.0.2/PKG-INFO`
...
+Requires-Dist: changecode (>=0.0.1)
