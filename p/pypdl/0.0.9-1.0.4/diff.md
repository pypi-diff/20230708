# Comparing `tmp/pypdl-0.0.9.tar.gz` & `tmp/pypdl-1.0.4.tar.gz`
...
## Comparing `pypdl-0.0.9.tar` & `pypdl-1.0.4.tar`
...
### Comparing `pypdl-0.0.9/LICENSE` & `pypdl-1.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `pypdl-0.0.9/PKG-INFO` & `pypdl-1.0.4/PKG-INFO`
...
### Comparing `pypdl-0.0.9/README.md` & `pypdl-1.0.4/README.md`
...
### Comparing `pypdl-0.0.9/pypdl/main.py` & `pypdl-1.0.4/pypdl/main.py`
...
### Comparing `pypdl-0.0.9/pypdl/test.py` & `pypdl-1.0.4/pypdl/test.py`
...
### Comparing `pypdl-0.0.9/pypdl/utls.py` & `pypdl-1.0.4/pypdl/utls.py`
...
### Comparing `pypdl-0.0.9/pypdl.egg-info/PKG-INFO` & `pypdl-1.0.4/pypdl.egg-info/PKG-INFO`
...
### Comparing `pypdl-0.0.9/setup.py` & `pypdl-1.0.4/setup.py`
