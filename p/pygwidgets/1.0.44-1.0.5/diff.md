# Comparing `tmp/pygwidgets-1.0.44.tar.gz` & `tmp/pygwidgets-1.0.5.tar.gz`
...
### Comparing `pygwidgets-1.0.44/pygwidgets_test/sounds/Nextbutton.wav` & `pygwidgets-1.0.5/pygwidgets_test/sounds/Nextbutton.wav`
