# Comparing `tmp/ypricemagic-2.7.1.dev3.tar.gz` & `tmp/ypricemagic-2.8.0.tar.gz`
...
### Comparing `ypricemagic-2.7.1.dev3/y/prices/eth_derivs/creth.py` & `ypricemagic-2.8.0/y/prices/eth_derivs/creth.py`
